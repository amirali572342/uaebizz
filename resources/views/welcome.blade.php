...
@section('content')
                            ...
                            <div class="search-background py-3 px-4 bg-white-transparent">
                                <div class="form row row-sm">
                                    ...
                                    <div class="form-group col-xl-3 col-lg-3 col-md-12 mb-0">
                                        ...
                                        <span><img src="{{asset('assets/frontend/images/svgs/gps.svg')}}" class="location-gps"
                                                   alt="img"></span>
                                    </div>
                                ...
                                <div class="cat-img category-svg">
                                    ...
                                    <svg style="enable-background:new 0 0 512 512;" version="1.1" viewbox="0 0 512 512"
                                        ...
                                        <g>
                                            <g>
                                                <path
                                                    d="M408.274,56.527h-0.087c-4.503,0-8.109,3.65-8.109,8.153c0,4.503,3.694,8.153,8.196,8.153s8.153-3.65,8.153-8.153 C416.427,60.177,412.776,56.527,408.274,56.527z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                        ...
                                        <g>
                                            <g>
                                                <path
                                                    d="M145.944,243.765c-3.896-8.085-13.292-13.311-23.939-13.311s-20.043,5.225-23.939,13.311 c-1.954,4.056-0.25,8.929,3.807,10.884c4.056,1.955,8.929,0.249,10.884-3.807c0.953-1.978,4.519-4.082,9.249-4.082 c4.73,0,8.295,2.103,9.249,4.082c1.404,2.917,4.318,4.617,7.351,4.617c1.187,0,2.393-0.261,3.533-0.81 C146.194,252.694,147.898,247.822,145.944,243.765z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path
                                                    d="M213.917,243.765c-3.895-8.085-13.291-13.311-23.939-13.311s-20.043,5.225-23.939,13.311 c-1.955,4.057-0.25,8.929,3.807,10.884c4.056,1.955,8.929,0.249,10.884-3.807c0.953-1.978,4.519-4.082,9.249-4.082 s8.295,2.103,9.249,4.082c1.404,2.917,4.318,4.617,7.351,4.617c1.187,0,2.393-0.261,3.533-0.81 C214.167,252.694,215.872,247.822,213.917,243.765z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path
                                                    d="M408.187,13.045c-57.243,0-103.813,46.57-103.813,103.813c0,30.035,12.718,57.98,35.132,77.723 c-11.247,18.412-23.453,29.023-23.578,29.131c-2.686,2.294-3.589,6.057-2.237,9.32c1.27,3.063,4.255,5.032,7.529,5.032 c0.214,0,0.43-0.009,0.647-0.025c1.341-0.107,31.956-2.721,59.114-20.983c8.851,2.4,17.984,3.616,27.207,3.616 c57.243,0,103.813-46.57,103.813-103.813C512,59.615,465.43,13.045,408.187,13.045z M408.187,204.365 c-8.93,0-17.757-1.349-26.236-4.011c-2.468-0.774-5.158-0.333-7.248,1.194c-10.038,7.327-21.056,12.056-30.517,15.084 c4.232-5.582,8.752-12.292,12.989-20.038c1.928-3.525,1.001-7.929-2.185-10.378c-21.805-16.751-34.31-42.032-34.31-69.358 c0-48.252,39.255-87.507,87.507-87.507c48.252,0,87.507,39.255,87.507,87.507C495.694,165.11,456.439,204.365,408.187,204.365z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                    ...
                    <div class="card mb-0 overflow-hidden">
                        <div class="card-body">
                            <div class="cat-item text-center">
                                ...
                                <div class="cat-img category-svg">
                                    <!--Computer Icon Svg -->
                                    <svg style="enable-background:new 0 0 511.999 511.999;" version="1.1"
                                         viewbox="0 0 511.999 511.999" x="0px" xmlns="http://www.w3.org/2000/svg"
                                         y="0px">
                                        <g>
                                            <g>
                                                <path
                                                    d="M386.455,198.212l-53.811-53.811c-3.253-3.254-8.528-3.255-11.784,0c-3.254,3.253-3.254,8.529,0,11.783l47.92,47.92 l-47.92,47.919c-3.254,3.253-3.254,8.529,0,11.783c1.628,1.628,3.76,2.441,5.892,2.441c2.132,0,4.265-0.814,5.891-2.44 l53.811-53.811C389.709,206.742,389.709,201.466,386.455,198.212z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path
                                                    d="M143.223,204.102l47.919-47.92c3.254-3.253,3.254-8.529,0-11.783c-3.253-3.254-8.529-3.254-11.783,0l-53.811,53.811 c-3.254,3.253-3.254,8.529,0,11.783l53.811,53.811c1.626,1.628,3.759,2.441,5.891,2.441s4.265-0.814,5.891-2.442 c3.254-3.253,3.254-8.529,0-11.783L143.223,204.102z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path
                                                    d="M283.22,118.176c-4.386-1.39-9.07,1.041-10.458,5.427L223.356,279.57c-1.39,4.387,1.04,9.07,5.427,10.46 c0.838,0.266,1.685,0.391,2.519,0.391c3.535,0,6.816-2.269,7.941-5.818l49.404-155.967 C290.037,124.248,287.607,119.565,283.22,118.176z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path
                                                    d="M471.246,24.766H40.754C18.283,24.766,0,43.049,0,65.52v59.227c0,4.602,3.731,8.332,8.332,8.332 c4.601,0,8.332-3.731,8.332-8.332V65.52c0-13.284,10.807-24.09,24.09-24.09h430.492c13.284,0,24.09,10.807,24.09,24.09v284.411 h-52.21c-4.602,0-8.332,3.731-8.332,8.332s3.731,8.332,8.332,8.332h52.21v15.273c0,13.284-10.807,24.09-24.09,24.09h-155.41 H196.164H40.754c-13.284,0-24.09-10.807-24.09-24.09v-15.273h398.688c4.602,0,8.332-3.731,8.332-8.332s-3.731-8.332-8.332-8.332 H16.664V152.522c0-4.602-3.731-8.332-8.332-8.332c-4.601,0-8.332,3.73-8.332,8.332V381.87c0,22.472,18.283,40.754,40.754,40.754 H183.54l-20.494,47.945h-40.034c-4.602,0-8.332,3.731-8.332,8.332s3.731,8.332,8.332,8.332h265.975 c4.602,0,8.332-3.731,8.332-8.332s-3.731-8.332-8.332-8.332h-40.034l-20.494-47.945h142.786c22.472,0,40.754-18.282,40.754-40.754 V65.52C512,43.049,493.717,24.766,471.246,24.766z M330.83,470.568H181.17l14.238-33.31h121.185L330.83,470.568z">
                                                </path>
                                            </g>
                                        </g>
                                        <g>
                                            <g>
                                                <path
                                                    d="M262.924,379.679c-1.914-2.906-5.583-4.299-8.952-3.457c-3.517,0.879-6.116,4.048-6.291,7.67 c-0.364,7.534,9.106,11.629,14.33,6.172C264.674,387.282,265.089,382.887,262.924,379.679z">
                                                </path>
                                            </g>
                                        </g>
                                        <g></g>
                        ...
                        <div class="card-body">
                            <div class="cat-item text-center">
                                ...
                                <div class="cat-img category-svg">
                                    ...
                                    <svg viewBox="0 -24 480 480" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="m440 0h-400c-22.082031.0273438-39.9726562 17.917969-40 40v272c.0273438 22.082031 17.917969 39.972656 40 40h400c22.082031-.027344 39.972656-17.917969 40-40v-272c-.027344-22.082031-17.917969-39.9726562-40-40zm24 312c0 13.253906-10.746094 24-24 24h-400c-13.253906 0-24-10.746094-24-24v-272c0-13.253906 10.746094-24 24-24h400c13.253906 0 24 10.746094 24 24zm0 0" />
                                        <path
                                            d="m440 32h-400c-4.417969 0-8 3.582031-8 8v272c0 4.417969 3.582031 8 8 8h400c4.417969 0 8-3.582031 8-8v-272c0-4.417969-3.582031-8-8-8zm-8 272h-384v-256h384zm0 0" />
                                        <path
                                            d="m472 368h-464c-4.417969 0-8 3.582031-8 8 .0390625 30.910156 25.089844 55.960938 56 56h368c30.910156-.039062 55.960938-25.089844 56-56 0-4.417969-3.582031-8-8-8zm-48 48h-368c-19-.019531-35.375-13.386719-39.199219-32h446.398438c-3.824219 18.613281-20.199219 31.980469-39.199219 32zm0 0" />
                                        <path
                                            d="m56 408h368c4.417969 0 8-3.582031 8-8s-3.582031-8-8-8h-368c-4.417969 0-8 3.582031-8 8s3.582031 8 8 8zm0 0" />
                                    </svg>
                                    <!--Electronics Icon Svg -->
                                </div>
                                <div class="cat-desc">
                ...
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        ...
                        <div class="item-card2-img">
                            <a href="{{route('post-detail')}}" class="absolute-link"></a>
                        ...
                        <div class="card-body pb-0">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    <div class="item-card2-text">
                                        <a href="#" class="text-dark">
                                            <h4 class="mb-0">GilkonStar Hotel</h4>
                                        </a>
                                    </div>
                                    <div class="pt-3">
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i
                                                    class="fa fa-map-marker me-2"></i>Hollowstead, USA</p>
                                        </a>
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-phone me-2"></i>+63
                                                658-965-865</p>
                                        </a>
                                        <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-clock-o me-2"></i>9am - 9pm<a>
                                                <span class="badge badge-success ms-2 fs-13">Open Now</span></a></p>
                                    </div>
                                    <p class="">Lorem ipsum dolor sit amet, quis int nostrum exercitationem </p>
                                </div>
                        ...
                        <div class="card-body pb-0">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    <div class="item-card2-text">
                                        <a href="#" class="text-dark">
                                            <h4 class="mb-0">Sear Beauty & Spa</h4>
                                        </a>
                                    </div>
                                    <div class="pt-3">
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i
                                                    class="fa fa-map-marker me-2"></i>Mannorstead, China</p>
                                        </a>
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-phone me-2"></i>+63
                                                965-865-956</p>
                                        </a>
                                        <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-clock-o me-2"></i>8am - 6pm<a>
                                                <span class="badge badge-danger ms-2 fs-13">Closed</span></a></p>
                                    </div>
                                    <p class="">Lorem ipsum dolor sit amet, quis int nostrum exercitationem </p>
                                </div>
                            </div>
                        ...
                        <div class="card-body pb-0">
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    <div class="item-card2-text">
                                        <a href="#" class="text-dark">
                                            <h4 class="mb-0">Seep Automobiles</h4>
                                        </a>
                                    </div>
                                    <div class="pt-3">
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-map-marker me-2"></i>East
                                                Hardfolk, UK</p>
                                        </a>
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-phone me-2"></i>+63
                                        ...
                                        <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-clock-o me-2"></i>9am - 7pm<a>
                                                <span class="badge badge-success ms-2 fs-13">Open Now</span></a></p>
                                    </div>
                                    <p class="">Lorem ipsum dolor sit amet, quis int nostrum exercitationem </p>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="d-flex">
                                        <div class="d-inline-flex">
                                            <div class="rating-star sm my-rating-5" data-rating="2.5">
                                            </div> (14 Reviews)
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item-card2">
                                <div class="item-card2-desc">
                                    ...
                                    <div class="pt-3">
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i
                                                    class="fa fa-map-marker me-2"></i>Factdale, Canada</p>
                                        </a>
                                        <a href="mb-1">
                                            <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-phone me-2"></i>+63
                                                854-968-854</p>
                                        </a>
                                        <p class="pb-0 pt-0 mb-2 mt-2"><i class="fa fa-clock-o me-2"></i>10am - 7pm<a>
                                                <span class="badge badge-danger ms-2 fs-13">Closed</span></a></p>
                                    </div>
                                    <p class="">Lorem ipsum dolor sit amet, quis int nostrum exercitationem </p>
                                </div>
                        ...
                        <div class="card-footer">
                            <div class="item-card2-footer">
                                <div class="item-card2-footer-u">
                                    <div class="d-flex">
                                        <div class="d-inline-flex">
                                            <div class="rating-star sm my-rating-5" data-rating="3">
                                            </div> (42 Reviews)
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="myCarousel" class="owl-carousel testimonial-owl-carousel">
                        <div class="item card mb-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="h-100">
                                        <img src={{asset('assets/frontend/images/products/products/f4.jpg')}} alt="img"
                                             class="w-100 h-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="item card mb-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="h-100">
                                        <img src={{asset('assets/frontend/images/products/products/ed3.jpg')}} alt="img"
                                             class="w-100 h-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="item card mb-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="h-100">
                                        <img src={{asset('assets/frontend/images/products/products/yoga2.jpg')}} alt="img"
                                             class="w-100 h-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="item card mb-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="h-100">
                                        <img src={{asset('assets/frontend/images/products/products/bakery4.jpg')}} alt="img"
                                             class="w-100 h-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="item card mb-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="h-100">
                                        <img src={{asset('assets/frontend/images/products/products/h1.jpg')}} alt="img"
                                             class="w-100 h-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="item card mb-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6">
                                    <div class="h-100">
                                        <img src={{asset('assets/frontend/images/products/products/b4.jpg')}} alt="img"
                                             class="w-100 h-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
            ...
            <div id="myCarousel2" class="owl-carousel owl-carousel-icons2">
                ...
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        ...
                        <div class="item-card7-overlaytext">
                            <a href="#" class="text-white"> Beauty & Spa </a>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="footerimg d-flex mt-0 mb-0">
                                <div class="d-flex footerimg-l mb-0">
                                    <img src={{asset('assets/frontend/images/faces/female/17.jpg')}} alt="image"
                ...
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        ...
                        <div class="item-card7-overlaytext">
                            <a href="#" class="text-white"> RealEstate</a>
                        </div>
                        <div class="card-body">
                            <div class="item-card7-desc">
                                <div class="item-card7-text">
                        ...
                        <div class="card-footer">
                            <div class="footerimg d-flex mt-0 mb-0">
                                <div class="d-flex footerimg-l mb-0">
                                    <img src={{asset('assets/frontend/images/faces/male/17.jpg')}} alt="image"
                                         class="avatar brround  me-2">
                ...
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        ...
                        <div class="item-card7-overlaytext">
                            <a href="#" class="text-white"> AutoMobile</a>
                        </div>
                        <div class="card-body">
                            <div class="item-card7-desc">
                                <div class="item-card7-text">
                        ...
                        <div class="card-footer">
                            <div class="footerimg d-flex mt-0 mb-0">
                                <div class="d-flex footerimg-l mb-0">
                                    <img src={{asset('assets/frontend/images/faces/male/18.jpg')}} alt="image"
                                         class="avatar brround  me-2">
                ...
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        ...
                        <div class="card-footer">
                            <div class="footerimg d-flex mt-0 mb-0">
                                <div class="d-flex footerimg-l mb-0">
                                    <img src={{asset('assets/frontend/images/faces/female/12.jpg')}} alt="image"
                                         class="avatar brround  me-2">
                                    <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">Wendy Peake<i
                                            class="icon icon-check text-success fs-12 ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="verified"></i></h5>
                ...
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        ...
                        <div class="card-footer">
                            <div class="footerimg d-flex mt-0 mb-0">
                                <div class="d-flex footerimg-l mb-0">
                                    <img src={{asset('assets/frontend/images/faces/female/19.jpg')}} alt="image"
                                         class="avatar brround  me-2">
    ...
    <section>
        <div class="about-1 cover-image sptb bg-background-color"
             data-bs-image-src="{{asset('assets/frontend/images/banners/banner5.jpg')}}">
                            ...
                            <div class="tab-pane active" id="tab-1">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img  br-te-4 br-ts-4">
                                                <img src={{asset('assets/frontend/images/products/products/f2.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img  br-te-4 br-ts-4">
                                                <img src={{asset('assets/frontend/images/products/products/h2.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/female/1.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Jodie Melton<i
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-lg-0 overflow-hidden">
                                            <div class="item-card8-img  br-te-4 br-ts-4">
                                                <img src={{asset('assets/frontend/images/products/products/j1.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/male/19.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Rogelio Brown<i
                                                                class="icon icon-check text-success fs-12 ms-1"
                            ...
                            <div class="tab-pane" id="tab-2">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img  br-te-4 br-ts-4">
                                                <img src={{asset('assets/frontend/images/products/products/f1.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/female/2.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Thu Astudillo<i
                                                                class="icon icon-check text-success fs-12 ms-1"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img">
                                                <img src={{asset('assets/frontend/images/products/products/j2.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/male/2.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Shelton Vause <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-0 overflow-hidden">
                                            <div class="item-card8-img">
                                                <img src={{asset('assets/frontend/images/products/products/j3.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/female/3.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Ellena Beachy <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                            ...
                            <div class="tab-pane" id="tab-3">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img  br-te-4 br-ts-4">
                                                <img src={{asset('assets/frontend/images/products/products/b1.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/female/5.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Vania Pease <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-0 overflow-hidden">
                                            <div class="item-card8-img">
                                                <img src={{asset('assets/frontend/images/products/products/b2.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/male/5.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Chery Fogle <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-lg-0 overflow-hidden">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/female/6.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Leonila Payson <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                            ...
                            <div class="tab-pane" id="tab-4">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img  br-te-4 br-ts-4">
                                                <img src={{asset('assets/frontend/images/products/products/h4.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/male/7.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/male/8.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Hobert Dillon <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-0 overflow-hidden">
                                            <div class="item-card8-img">
                                                <img src={{asset('assets/frontend/images/products/products/h3.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                            ...
                                            <div class="card-footer">
                                                <div class="footerimg d-flex mt-0 mb-0">
                                                    <div class="d-flex footerimg-l mb-0">
                                                        <img src={{asset('assets/frontend/images/faces/female/10.jpg')}} alt="image"
                                                             class="avatar brround  me-2">
                                                        <h5 class="time-title text-muted p-0 leading-normal mt-2 mb-0">
                                                            Angele Vorpahl <i
                                                                class="icon icon-check text-success fs-12 ms-1"
                            ...
                            <div class="tab-pane" id="tab-5">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12">
                                        <div class="card mb-xl-0 overflow-hidden">
                                            <div class="item-card8-img">
                                                <img src={{asset('assets/frontend/images/products/products/f3.jpg')}} alt="img"
                                                     class="cover-image">
                                            </div>
                                            <div class="item-card8-overlaytext">
                                    ...
                                    <div class="testimonia">
                                        ...
                                        <div class="owl-controls clickable">
                                            <div class="owl-pagination">
                                                <div class="owl-page active me-1">
                                                    <span class=""></span>
                                                </div>
                                                <div class="owl-page me-1">
                                                    <span class=""></span>
                                                </div>
                                                <div class="owl-page me-1">
                                                    <span class=""></span>
                    ...
                    <div class="item-card overflow-hidden">
                        <div class="item-card-desc">
                            ...
                            <div class="card text-center overflow-hidden mb-lg-0">
                                <div class="card-img">
                                    <img src={{asset('assets/frontend/images/locations/germany1.jpg')}} alt="img" class="cover-image">
                                </div>
                ...
                <div class="col-sm-12 col-lg-3 col-md-6">
                    <div class="item-card overflow-hidden">
                        <div class="item-card-desc">
                            ...
                            <div class="card text-center overflow-hidden mb-lg-0">
                                <div class="card-img">
                                    <img src={{asset('assets/frontend/images/locations/london1.jpg')}} alt="img" class="cover-image">
                                </div>
                                <div class="item-card-text text-start">
                                    <div class="rating-star sm my-rating-5" data-rating="5"></div>
                    ...
                    <div class="item-card overflow-hidden">
                        <div class="item-card-desc">
                            ...
                            <div class="card text-center overflow-hidden mb-md-0">
                                <div class="card-img">
                                    <img src={{asset('assets/frontend/images/locations/austrelia1.jpg')}} alt="img" class="cover-image">
                                </div>
                                <div class="item-card-text text-start">
                                    <div class="rating-star sm my-rating-5" data-rating="5"></div>
                    ...
                    <div class="item-card overflow-hidden">
                        <div class="item-card-desc">
                            ...
                            <div class="card text-center overflow-hidden mb-0">
                                <div class="card-img">
                                    <img src={{asset('assets/frontend/images/locations/canada1.jpg')}} alt="img" class="cover-image">
                                </div>
                                <div class="item-card-text text-start">
                                    <div class="rating-star sm my-rating-5" data-rating="5"></div>
    ...
    <!--Section-->
    <section class="sptb cover-image patter-image" data-bs-image-src="{{asset('assets/frontend/images/pngs/7.png')}}">
        <div class="container">
            <div class="section-title center-block text-center">
                <h2>Download App</h2>
                <p>Mauris ut cursus nunc. Morbi eleifend, ligula at consectetur vehicula</p>
                    ...
                    <div class="text-center text-wrap">
                        <div class="btn-list">
                            ...
                            <a href="javascript:void(0)" class="btn btn-primary btn-lg mb-sm-0"><i class="fa fa-android fa-1x me-2"></i>
                                Google Play</a>
                            <a href="javascript:void(0)" class="btn btn-info btn-lg mb-sm-0"><i class="fa fa-windows fa-1x me-2"></i>
                                Windows</a>
                        </div>
                    </div>
                </div>
